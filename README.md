...
Esta versão permite testar a instalação, o mecanismo de atualização, o login nas contas existentes e o menu correspondente ao perfil. A 0.1.7 impede espera infinita no carregamento, usa uma conexão mais compatível no Android e oferece nova tentativa. Ainda não possui registro de atendimentos ou envio em segundo plano. Não usar para trabalho operacional.
