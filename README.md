...
A versão 0.1.10 permite testar a instalação, o mecanismo de atualização, o login nas contas existentes e o menu correspondente ao perfil. Ela mantém a sessão por até dois dias e guarda nome e senha cifrados pelo cofre do Android para preencher o próximo login. Ainda não possui registro de atendimentos ou envio em segundo plano. Não usar para trabalho operacional.

A 0.1.10 usa a mesma chave definitiva da 0.1.9 e pode ser instalada pelo botão de atualização do aplicativo. A reinstalação manual foi necessária somente na passagem da 0.1.8 para a 0.1.9.
